...
<form action="/products" method="POST" class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4 w-[50%] min-h-[20rem]" >
    @csrf 
      <div class="mb-4">
        ...
        <div>
          ...
          <input type="text" value="{{old('quantity')}}"  id="quantityInput" name="quantity" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
      ...
      <div>
          ...
          <input value="{{old('expirationDate')}}" type="date" name="expiration_date" id="" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
